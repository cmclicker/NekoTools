...
/**
 * Build a NekoINI registration for the runtime. The free build passes only
 * the free parser and exporters; Pro ids declared in the manifest (.env /
 * TOML conversion) are not registered here.
 */
