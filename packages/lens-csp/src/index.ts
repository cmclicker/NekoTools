...
/**
 * Build a NekoCSP registration for the runtime. The free build passes only
 * the free parser and exporters; Pro ids declared in the manifest
 * (report, hardened) are not registered here.
 */
